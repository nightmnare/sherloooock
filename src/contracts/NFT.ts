...
export interface NFTInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [string, BigNumberish, string, BigNumberish, BytesLike[], BigNumberish]
  ): string
  ...
  encodeFunctionData(
    ...
    values: [string, string, string, string, string[], string, string, BigNumberish, BigNumberish, string]
  ): string
...
export type MaxTotalSupplyUpdatedEvent = TypedEvent<[BigNumber], { maxTotalSupply: BigNumber }>

export type MaxTotalSupplyUpdatedEventFilter = TypedEventFilter<MaxTotalSupplyUpdatedEvent>

export type MaxWalletClaimCountUpdatedEvent = TypedEvent<[BigNumber], { count: BigNumber }>

export type MaxWalletClaimCountUpdatedEventFilter = TypedEventFilter<MaxWalletClaimCountUpdatedEvent>

export type NFTRevealedEvent = TypedEvent<[BigNumber, string], { endTokenId: BigNumber; revealedURI: string }>

export type NFTRevealedEventFilter = TypedEventFilter<NFTRevealedEvent>

export type OwnerUpdatedEvent = TypedEvent<[string, string], { prevOwner: string; newOwner: string }>
...
export type PrimarySaleRecipientUpdatedEvent = TypedEvent<[string], { recipient: string }>
...
export type WalletClaimCountUpdatedEvent = TypedEvent<[string, BigNumber], { wallet: string; count: BigNumber }>
...
export interface NFT extends BaseContract {
  ...
  functions: {
    ...
    encryptDecrypt(data: BytesLike, key: BytesLike, overrides?: CallOverrides): Promise<[string] & { result: string }>
  ...
  setOwner(_newOwner: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
  ...
  estimateGas: {
    ...
    setContractURI(_uri: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
